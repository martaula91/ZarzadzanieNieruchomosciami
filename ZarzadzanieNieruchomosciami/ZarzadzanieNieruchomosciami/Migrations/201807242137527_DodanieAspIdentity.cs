namespace ZarzadzanieNieruchomosciami.Migrations
{
    ...
    public partial class DodanieAspIdentity : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DaneUzytkownika_UzytkownikId = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DaneUzytkownika", t => t.DaneUzytkownika_UzytkownikId)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.DaneUzytkownika_UzytkownikId);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.AspNetUsers", new[] { "DaneUzytkownika_UzytkownikId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropTable("dbo.AspNetUserLogins");
            DropTable("dbo.DaneUzytkownika");
